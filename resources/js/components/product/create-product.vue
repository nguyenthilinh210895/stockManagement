                ...
                <section class="panel">
                    ...
                    <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                            ...
                            <div class="bio-row">
                                <div class="col-md-3">
                                    <label for="manufa" class="label-size-20">Manufacturer</label>
                                </div>
                                <div class="col-md-6">
                                    <select
                                        class="form-control cs-select-form"
                            ...
                            <div class="bio-row">
                                <div class="col-md-3">
                                    <label for="group" class="label-size-20">Item Group</label>
                                </div>
                                <div class="col-md-6">
                                    <select
                                        class="form-control cs-select-form"
                            ...
                            <div class="bio-row">
                                <div class="col-md-3">
                                    <label for="unit" class="label-size-20">Calculation Unit</label>
                                </div>
                                <div class="col-md-6">
                                    <select
                                        class="form-control cs-select-form"
                            ...
                            <div class="bio-row">
                                <div class="col-md-3">
                                    <label for="quality" class="label-size-20">Quality</label>
                                </div>
                                <div class="col-md-6">
                                    <select
                                        class="form-control cs-select-form"
                ...
                <section class="panel">
                    <div class="panel-body bio-graph-info">
                        <form class="form-horizontal" role="form" onsubmit="return false;">
                            ...
                            <div class="form-group">
                                <label  class="col-lg-2 control-label">Out of date</label>
                                <div class="col-lg-6">
                                    <input type="text" name="out_of_date" v-model="product.out_of_date"  class="form-control" id="out_of_date" placeholder=" ">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-2 control-label">Product color</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button @click="handleCreate" class="btn btn-success">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
